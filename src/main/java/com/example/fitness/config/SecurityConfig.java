    ...
    public UserDetailsService user(){
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
            return http
                    ...
                    .authorizeHttpRequests(auth -> auth.requestMatchers("/user/**", "/trainer/**", "/food/**","/exercise/**", "/diet/**", "/workout/**", "/ws/**").permitAll().requestMatchers("/home/**").hasAuthority("GUEST").anyRequest().authenticated())
